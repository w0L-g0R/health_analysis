...
#
# async def bootstrap():
#     app_container = EventClientContainer()
...
# # async def start():
# #     print("start")
# #     await asyncio.gather(meals_broker.startup(), health_broker.startup())
# #
# #     tasks = [
# #         asyncio.create_task(t, name=t.__name__) for t in [task1.kiq(), task2.kiq()]
# #     ]
# #
...
# #     # r1, r2 = await asyncio.gather(t1.wait_result(timeout=2), t2.wait_result(timeout=2))
# #     # print("r1: ", r1)
# #     # print("r2: ", r2)
# #     await asyncio.gather(meals_broker.shutdown(), health_broker.shutdown())
#
...
# #
# #     # Run brokers in their respective event loops
# #     try:
# #         asyncio.set_event_loop(loop1)
# #         loop1.run_until_complete(broker1.startup())  # Assume `start` is an async method
# #
# #         asyncio.set_event_loop(loop2)
# #         loop2.run_until_complete(broker2.startup())
# #     finally:
# #         # Clean up event loops properly
# #         loop1.close()
# #         loop2.close()
#
# # meals = [
...
# #     "taskiq",
# #     "worker",
# #     f"src.main:health_broker",
# # ]
# #
# # bootstrap = [
# #     sys.executable,
# #     "-c",
# #     "import asyncio; from src.main import start; asyncio.run(start())",
# # ]
# #
# # commands = [meals, health, bootstrap]
# # cpus = 3
# #
# # with ProcessPoolExecutor(max_workers=cpus) as executor:
# #     try:
# #         futures = executor.map(run_parallel, commands)
# #         # sleep(5)
# #
# #     except KeyboardInterrupt:
# #         logging.info("Keyboard interrupt received. Shutting down workers.")
# #         executor.shutdown(wait=True)
# #         logging.info("Workers have been shut down.")
# #         raise
#
# # process1 = None
# # process2 = None
